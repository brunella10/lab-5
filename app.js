...
function multiply(a,b) { //eslint-disable-line
  var arg1 = a * b;
  var text = 'The product of ' + a + ' and ' + b + ' is ' + arg1 + '.';
  console.log(text);
  return [arg1, text];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  var anotherArray = multiply(MultiArray, testArray[2])[0];
  var message2 = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + anotherArray + '.';
  console.log('The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + anotherArray + '.');
  return[anotherArray, message2];
}
